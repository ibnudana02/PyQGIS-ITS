...
class ForestTrailsWindow(QMainWindow, Ui_MainWindow):
    ...
    def setupDatabase(self):
        ...
        if not os.path.exists(dbName):
            ...
            if writer.hasError() != QgsVectorFileWriter.NoError:
                "Error creating tracks database!"
    ...
    def setupMapLayers(self):
        ...
        # Raster base layer. # filename = os.path.join(cur_dir, "data", "bkgpkularge.tif")
        filename = os.path.join(cur_dir, "data", "bkg.tif")
        ...
        # Track layer, stored in an postgresql database.
        uri = QgsDataSourceURI()
        uri.setConnection("localhost", "5432", "db_dishub", "postgres", "ibn-dana10")
        uri.setDataSource("public", "rutes", "geom","")
        self.trackLayer = QgsVectorLayer(uri.uri(), "Tracks", "postgres")
